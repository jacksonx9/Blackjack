...
class Game():
    ...
    def setup(self):
        ...
        for player in players:
            player.insurance = 0
            bet = self.__get_bet(player, 'How much would you like to bet?',
                min_bet, 2)
            hand = Hand(bet)
            hands.append(hand)
            player.bet(bet)
